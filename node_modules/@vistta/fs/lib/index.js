 ...
 * @returns {Promise<void>}
 */
export const appendFile = (path, data, options) =>
  _fs.promises.appendFile(path, data, options);
 ...
 * @returns {Promise<void>}
 */
export const copyFile = (source, destination, mode) =>
  _fs.promises.copyFile(source, destination, mode);
 ...
 * @returns {void}
 */
export const copyFileSync = (source, destination, mode) =>
  _fs.copyFileSync(source, destination, mode);
...
export const cp = (source, destination, options) =>
  _fs.promises.cp(source, destination, options);
...
export const cpSync = (source, destination, options) =>
  _fs.cpSync(source, destination, options);
 ...
 * @returns {void}
 */
export const copySync = (source, destination, options) =>
  _fs.cpSync(source, destination, options);
...
export const createReadStream = (path, options) =>
  _fs.createReadStream(path, options);
...
export const createWriteStream = (path, options) =>
  _fs.createWriteStream(path, options);
...
export const futimesSync = (fd, atime, mtime) =>
  _fs.futimesSync(fd, atime, mtime);
 ...
 * @returns {Promise<void>}
 */
export const lutimes = (path, atime, mtime) =>
  _fs.promises.lutimes(path, atime, mtime);
 ...
 * @returns {void}
 */
export const lutimesSync = (path, atime, mtime) =>
  _fs.lutimesSync(path, atime, mtime);
 ...
 * @returns {Promise<void>}
 */
export const link = (existingPath, newPath) =>
  _fs.promises.link(existingPath, newPath);
 ...
 * @returns {void}
 */
export const linkSync = (existingPath, newPath) =>
  _fs.linkSync(existingPath, newPath);
...
export const mkdtemp = (prefix, options) =>
  _fs.promises.mkdtemp(prefix, options);
...
export const mkdtempSync = (prefix, options) =>
  _fs.mkdtempSync(prefix, options);
...
export const readSync = (fd, buffer, offset, length, position) =>
  _fs.readSync(fd, buffer, offset, length, position);
 ...
 */
export const readvSync = (fd, buffers, position) =>
  _fs.readvSync(fd, buffers, position);
...
realpathSync.native = (path, options) =>
  _fs.realpathSync?.native(path, options);
...
export const rename = (oldPath, newPath) =>
  _fs.promises.rename(oldPath, newPath);
...
export const stat = (path, options) => {
  if (options === true || options?.followLink)
    return _fs.promises.stat(path, options);
...
export const symlink = (target, path, type) =>
  _fs.promises.symlink(target, path, type);
...
export const symlinkSync = (target, path, type) =>
  _fs.symlinkSync(target, path, type);
...
export const utimes = (path, atime, mtime) =>
  _fs.promises.utimes(path, atime, mtime);
...
export const utimesSync = (path, atime, mtime) =>
  _fs.utimesSync(path, atime, mtime);
 ...
 * @returns {void}
 */
export const unwatchFile = (path, options, listener) =>
  _fs.unwatchFile(path, options, listener);
 ...
 * @returns {void}
 */
export const watchFile = (path, options, listener) =>
  _fs.watchFile(path, options, listener);
...
export const writeFile = (path, data, options) =>
  _fs.promises.writeFile(path, data, options);
 ...
 * @returns {number} Buffer containing the file data.
 */
export const writeSync = (fd, buffer, offset, length, position) =>
  _fs.writeSync(fd, buffer, offset, length, position);
 ...
 * @returns {number} The number of bytes read.
 */
export const writevSync = (fd, buffers, position) =>
  _fs.writevSync(fd, buffers, position);
...
export const dirname = (path) =>
  _path?.dirname(
    path instanceof URL || new RegExp("[^:]*://").test(path)
      ? fileURLToPath(path)
      : path
  );
